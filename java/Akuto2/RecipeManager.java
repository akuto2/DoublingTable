...
public class RecipeManager {
	public static void addRecipe() {
		...
		GameRegistry.addRecipe(new ItemStack(doublingTable, 1, 6), "xxx", "xyx", "xxx", 'x', new ItemStack(Items.DYE, 1, 4), 'y', new ItemStack(doublingTable, 1, 5));
		GameRegistry.addRecipe(new ItemStack(doublingTable, 1, 7), "xxx", "xyx", "xxx", 'x', Items.REDSTONE, 'y', new ItemStack(doublingTable, 1, 6));
	}
}
