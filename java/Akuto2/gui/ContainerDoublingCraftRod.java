...
public class ContainerDoublingCraftRod extends Container{
	...
	public ContainerDoublingCraftRod(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5, int par6){
	...
	public void onCraftMatrixChanged(IInventory par1EntityPlayer){
		...
		if(itemStack != null){
			itemStack.stackSize *= this.magnification;
		}
